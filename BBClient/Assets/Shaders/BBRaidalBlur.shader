Shader "BB/RadialBlurFilter"
{
	Properties
	{
		...
		fCenterU("fCenterU", float) = 0.5
		fCenterV("fCenterV", float) = 0.5
	}
	...
	SubShader
	{
		...
		uniform float fCenterU;
		uniform float fCenterV;
		...
		float4 frag(v2f i) : COLOR
		{
			...
			float2 dir;// = 0.5 - texCo;
			dir.x = fCenterU - texCo.x;
			dir.y = fCenterV - texCo.y;
